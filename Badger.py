...
class Badger(Animal):
    def __init__(self,pos,game,key):
        ...
        self.idle_left_down_sheet = pygame.image.load("assets/animals/badger/critter_badger_SW_idle.png").convert_alpha()
        self.idle_right_down_sheet = pygame.image.load("assets/animals/badger/critter_badger_SE_idle.png").convert_alpha()
        
        self.walk_right_up_sheet = pygame.image.load("assets/animals/badger/critter_badger_NE_walk.png").convert_alpha()
        self.walk_left_up_sheet = pygame.image.load("assets/animals/badger/critter_badger_NW_walk.png").convert_alpha()
        self.walk_left_down_sheet = pygame.image.load("assets/animals/badger/critter_badger_SW_walk.png").convert_alpha()
        self.walk_right_down_sheet = pygame.image.load("assets/animals/badger/critter_badger_SE_walk.png").convert_alpha()

        self.frames_number_idle = 22
        self.frames_number = 9
